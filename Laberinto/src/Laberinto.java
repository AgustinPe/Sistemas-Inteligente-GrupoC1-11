...
public class Laberinto {
	...
	public void generar_camino() {
		...
		System.out.println("Inicio: "+fila+" - "+columna+" : "+laberintoAuxiliar[actual[0]][actual[1]].getVisitada());
		actual[0] = fila;
		actual[1] = columna;		
		...
		camino.add(laberintoAuxiliar[fila][columna]);	
		 	...
		 	do {
		 		...
		 		System.out.println("Direccion salto: "+direccion_salto+"-"
		 		+laberintoAuxiliar[actual[0]][actual[1]].getNeighbors()[direccion_salto]);
		 		...
		 		while (laberintoAuxiliar[actual[0]][actual[1]].getNeighbors()[direccion_salto] || 
		 			...
		 			direccion_salto = r.nextInt(4);
		 			System.out.println("Nueva direccion: "+direccion_salto);
			 		System.out.println(laberintoAuxiliar[actual[0]][actual[1]].getNeighbors()[direccion_salto]);
		 		}
		 		switch(direccion_salto) {
					case 0:
		 		...
		 		if(celda_repetida(camino, laberintoAuxiliar[actual[0]][actual[1]])) {
		 			bucle_generado = true;
		 			System.out.println("BUCLE : "+actual[0]+" - "+actual[1]);
		 		}else{
		 			camino.add(laberintoAuxiliar[actual[0]][actual[1]]);
		 			System.out.println(+actual[0]+" - "+actual[1]+" : "+laberintoAuxiliar[actual[0]][actual[1]].getVisitada());
		 		}		 		
